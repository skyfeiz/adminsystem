...
(function(win,doc){
	...
	p.iframeCreate = function (src,str) {
		var cur = this,
			...
			frameStr = '<iframe src="'+src+'" class="f-pressent" frameborder="0" width="'+frameW+'" height="'+frameH+'"></iframe>';

		$('.iframe-box').append(frameStr);
